<%@ Page Language="C#" AutoEventWireup="true" CodeFile="formthemHoaDonXuat.aspx.cs" Inherits="_Default" %>
...
<body style="width: 322px; height: 178px">
    <form id="form1" runat="server">
        <table cellpadding="2" class="auto-style1">
            ...
            <tr>
                <td class="auto-style2">ID Tài Khoản</td>
                <td>
                    <asp:TextBox ID="ngaylap" runat="server" Width="186px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style2">Ngày xuất</td>
                <td>
