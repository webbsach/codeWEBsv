...
<html>
   <head>
      ...
      <title>Welcome to LoLy BookStore</title>
            ...
            <div class="container">
               <div class="row">
                  <div class="col-md-2 col-sm-2">
                     <div class="logo"><a href="<%Page.Request.Url.ToString(); %>"><img src="images/logo.png" alt="FlatShop"></a></div>
                  </div>
         ...
         <div class="container_fullwidth">
            <div class="container">
               <div class="hot-products">
                  <h3 class="title">Sách <strong>Hot</strong></h3>
                        ...
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="details.html"><img src="images/truyentranh/TT002.jpg" alt="Product Name"></a></div>
                                 <div class="productname">One Piece</div>
                                 <h4 class="price">40.000 VND</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Thêm Giỏ</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.html"><img src="images/truyentranh/TT001.jpg" alt="Product Name"></a></div>
                                 <div class="productname">Naruto</div>
                                 <h4 class="price">40.000 VND</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Thêm Giỏ</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 ...
                                 <div class="thumbnail"><a href="details.html"><img src="images/sachkinhdoanh/KD001.jpg" alt="Product Name"></a></div>
                                 <div class="productname">Đắc Nhân Tâm</div>
                                 <h4 class="price">70.000 VND</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Thêm Giỏ</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.html"><img src="images/sachonluyen/OL001.jpg" alt="Product Name"></a></div>
                                 <div class="productname">Starter TOEIC</div>
                                 <h4 class="price">135.000 VND</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Thêm Giỏ</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
                        </div>
                     ...
                     <li>
                        <div class="row">
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="offer">- %20</div>
                                 <div class="thumbnail"><a href="details.html"><img src="images/truyentranh/TT003.png" alt="Product Name"></a></div>
                                 <div class="productname">Fairy Tail</div>
                           ...
                           <div class="col-md-3 col-sm-6">
                              <div class="products">
                                 <div class="thumbnail"><a href="details.html"><img src="images/truyentranh/TT004.jpg" alt="Product Name"></a></div>
                                 <div class="productname">Attack On Titan</div>
                                 <h4 class="price">35.000 VND</h4>
                                 <div class="button_group"><button class="button add-cart" type="button">Thêm Giỏ</button><button class="button compare" type="button"><i class="fa fa-exchange"></i></button><button class="button wishlist" type="button"><i class="fa fa-heart-o"></i></button></div>
                              </div>
                           </div>
