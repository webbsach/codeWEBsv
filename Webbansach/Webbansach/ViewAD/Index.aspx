<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="ViewAD_Index" %>
...
<!--Header-part-->
<div id="header">
  <h1><a href="<%Page.Request.Url.ToString(); %>">Maruti Admin</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar"><a href="<%Page.Request.Url.ToString(); %>" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a><ul>
    <li class="active"><a href="<%Page.Request.Url.ToString(); %>"><i class="icon icon-home"></i> <span>Dashboard</span></a> </li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<%Page.Request.Url.ToString(); %>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a></div>
  </div>
  <div class="container-fluid">
   	<div class="quick-actions_homepage">
    <ul class="quick-actions">
          <li> <a href="<%Page.Request.Url.ToString(); %>"> <i class="icon-dashboard"></i> My Dashboard </a> </li>
            ...
            <div class="chat-users panel-right2">
              ...
              <div class="panel-content nopadding">
                <ul class="contact-list">
                  <li id="user-Sunil" class="online"><a href="index.html"><img alt="" src="img/demo/av1.jpg" /> <span>Sunil</span></a></li>
