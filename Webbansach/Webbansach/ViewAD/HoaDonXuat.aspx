<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HoaDonXuat.aspx.cs" Inherits="ViewAD_HoaDonXuat" %>
...
<body>
    <div id="main_container">
                    ...
                    <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="rounded">Mã Hóa Đơn Xuất</th>
                                <th scope="col" class="rounded">Mã Nhân Viên</th>
                                <th scope="col" class="rounded">Mã Tài Khoản</th>
                                <th scope="col" class="rounded">Ngày Xuất</th>
        ...
        <div class="footer">
            ...
            <div class="right_footer"><a href="http://indeziner.com">
                <img src="images/indeziner_logo.gif" alt="" title="" border="0" /></a></div>
